...
@section('content')
@parent
<div class="container register pt-4">
    <center>
        <h1>Registrasi</h1>
    </center>
    <br>
        ...
        <div class="card-sijabfung">
            ...
            <div class="card-sijabfung-body">
                <div class="form-sijabfung-group">
                    ...
                    <input type="email" name="email" class="form-control form-sijabfung" placeholder="name@example.com"
                        required>
                </div>
                <div class="form-sijabfung-group">
                    <label for="password">Sandi</label>
                    <input type="password" name="password" class="form-control form-sijabfung"
                        placeholder="Masukkan kata sandi" required>
                </div>
                <div class="form-sijabfung-group">
                    <label for="password">Konfirmasi Sandi</label>
                    <input type="password" name="confirm_password" class="form-control form-sijabfung"
                        placeholder="Masukkan kata sandi" required>
                </div>
                <!-- button -->
            </div>
        ...
        <div class="card-sijabfung">
            ...
            <div class="card-sijabfung-body">
                <div class="form-sijabfung-group">
                    ...
                    <input type="text" name="nip" class="form-control form-sijabfung" placeholder="" required>
                </div>
                <div class="form-sijabfung-group">
                    <label for="unitKerja">Nama</label>
                    <input type="text" name="nama" class="form-control form-sijabfung" placeholder="" required>
                </div>
                ...
                <div class="form-sijabfung-group">
                    ...
                    <input type="text" name="unit_kerja_saat_ini" class="form-control form-sijabfung"
                        placeholder="SMA N 7 Padang" required>
                </div>
            </div>
        </div>
        <center>
