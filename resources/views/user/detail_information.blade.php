...
<div class="information-details">
    ...
    <div class="field-details">
        ...
        <div class="field-content">
            <p>{{ Auth::user()->pegawai->birthday_place }},
                {{ date('d M Y', strtotime(Auth::user()->pegawai->birthday_date)) }}
            </p>
            <hr>
        </div>
    </div>
    ...
    <div class="field-details">
        ...
        <div class="field-content">
            <p>{{ Auth::user()->pegawai->jenjang_jabatan->detail_jabfung->jabatan_fungsional->rumpun_jabatan->nama }}
            </p>
            <hr>
        </div>
    </div>
    <div class="field-details">
        ...
        <div class="field-content">
            <p>{{ Auth::user()->pegawai->jenjang_jabatan->detail_jabfung->jabatan_fungsional->rumpun_jabatan->instansi_pembina->name }}
            </p>
            <hr>
        </div>
    </div>
