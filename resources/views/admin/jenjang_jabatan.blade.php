...
<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#modalAddJenjangJabatan" id="addJenjangJabatan"><i class="fas fa-download fa-sm text-white-50"></i> Tambah Data</a>
@endsection
...
@section('content')
  ...
  <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">DataTables Jenjang Jabatan</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="tableJenjangJabatan" width="100%" cellspacing="0">
                  <thead>
                    <tr>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">      
        ...
        <div class="form-group">
            <label for="selectPegawai">Kategori - Lingkup</label>          
            <select class="form-control select-select2" name="kategori">
              <option selected>Pilih Kategori - Lingkup</option>
            </select>
          </div> 
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="selectPegawai">Kategori</label>          
            <select class="form-control select-select2" name="kategori">
...
@section('script')
  ...
  <script src="{{asset('js/demo/datatables-jenjang-jabatan.js')}}"></script>
