...
/***/ "./resources/js/demo/datatables-jenjang-jabatan.js":
/*!*********************************************************!*\
  !*** ./resources/js/demo/datatables-jenjang-jabatan.js ***!
  \*********************************************************/
/*! no exports provided */
...
var getJenjangJabatan = $("#tableJenjangJabatan").DataTable({
  processing: true,
  ajax: {
...
var selectOptionKategoriLingkup = function selectOptionKategoriLingkup(data) {
  return $.get("/api/detail-jabfung/kategori-lingkup", {
    id_jabfung: data
  }, function (result, status) {
    ...
    result.forEach(function (element) {
      selectKategori.append("<option value=\"".concat(element.id, "\">").concat(element.kategori.name, " - ").concat(element.lingkup == 1 ? "Pusat" : "Daerah", "</option>"));
    });
  }).done(function (e) {}).fail(function (e) {}).always(function (e) {});
};

var insertJenjangJabatan = /*#__PURE__*/function () {
  ...
  return function insertJenjangJabatan(_x) {
...
var showDataToEdit = function showDataToEdit(data) {
  ...
  selectOptionIntansiPembina().done(function () {
    element.find('select[name="instansi-pembina"]').val(data.detail_jabfung.jabfung.rumpun_jabatan.id_instansi);
  }).then(function () {
    return new Promise(function () {
      selectOptionRumpunJabatan(data.detail_jabfung.jabfung.rumpun_jabatan.id_instansi).done(function () {
        element.find('select[name="rumpun-jabatan"]').val(data.detail_jabfung.jabfung.id_rumpun_jabatan);
      }).then(function () {
        return new Promise(function () {
          selectOptionJabatanFungsional(element.find('select[name="rumpun-jabatan"]').val()).done(function () {
            element.find('select[name="jabatan-fungsional"]').val(data.detail_jabfung.jabfung.id);
          }).then(function () {
            return new Promise(function () {
              selectOptionKategoriLingkup(element.find('select[name="jabatan-fungsional"]').val()).done(function () {
                element.find('select[name="kategori"]').val(data.detail_jabfung.id);
              });
            });
          });
        });
...
var updateJenjangJabatan = /*#__PURE__*/function () {
  ...
  return function updateJenjangJabatan(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

var deleteJenjangJabatan = function deleteJenjangJabatan(data) {
...
$(document).ready(function () {
  ...
  $('select[name="instansi-pembina"]').change(function () {
    ...
    $('select[name="jabatan-fungsional"]').append("<option>Pilih Jabatan Fungsional</option>");
...
/***/ 15:
/*!***************************************************************!*\
  !*** multi ./resources/js/demo/datatables-jenjang-jabatan.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\Projects\Git\sibafung-new\resources\js\demo\datatables-jenjang-jabatan.js */"./resources/js/demo/datatables-jenjang-jabatan.js");
