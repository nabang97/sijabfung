...
/***/ "./resources/js/demo/datatables-detail-jabfung.js":
/*!********************************************************!*\
  !*** ./resources/js/demo/datatables-detail-jabfung.js ***!
  \********************************************************/
/*! no exports provided */
...
var getJabatanFungsional = $("#tableJabFung").DataTable({
  processing: true,
  ajax: {
...
var selectOptionIntansiPembina = function selectOptionIntansiPembina() {
  $.get("/api/instansi-pembina", function (data, status) {
    var selectInstansiPembina = $('select[name="instansi-pembina"]');
...
var selectOptionRumpunJabatan = function selectOptionRumpunJabatan(value) {
  return $.get("/api/rumpun-jabatan-option", {
    ...
    var selectRumpunJabatan = $('select[name="rumpun-jabatan"]');
...
var selectOptionKategori = function selectOptionKategori() {
  $.get("/api/kategori", function (data, status) {
    var selectKategori = $("#checkbox-kategori");
    selectKategori.empty();
    selectKategori.append("<label for=\"selectJabatan\">Kategori</label> <br>");
    var no = 0;
    data.forEach(function (element) {
      no = no + 1;
      selectKategori.append("\n            <div class=\"form-check form-check-inline\">\n                <input class=\"form-check-input check-kategori\" type=\"checkbox\" id=\"checkbox".concat(no, "\" value=\"").concat(element.id, "\">\n                <label class=\"form-check-label\" for=\"checkbox").concat(no, "\">").concat(element.name, "</label>\n            </div>\n            "));
    });
  }).done(function (e) {}).fail(function (e) {}).always(function (e) {});
};
...
var insertDetailJabFung = /*#__PURE__*/function () {
  ...
  return function insertDetailJabFung(_x) {
    return _ref.apply(this, arguments);
  };
}();

var checkDetailJabfung = /*#__PURE__*/function () {
          ...
          case 0:
            $.post("/api/detail-jabfung/check", {
              ...
              if (e == "") {
                ...
                alert("data ".concat(data.message, " already exist"));
              }
            }).fail(function (e) {}).always(function (e) {});
  ...
  return function checkDetailJabfung(_x2) {
...
var showDataToEdit = function showDataToEdit(data) {
  ...
  element.find('select[name="instansi-pembina"]').val(data.jabfung.rumpun_jabatan.id_instansi);
  selectOptionRumpunJabatan(data.jabfung.rumpun_jabatan.id_instansi).done(function () {
    element.find('select[name="rumpun-jabatan"]').val(data.jabfung.id_rumpun_jabatan);
  }).then(function () {
    return new Promise(function () {
      selectOptionJabatanFungsional(data.jabfung.id_rumpun_jabatan).done(function () {
        element.find('select[name="jabatan-fungsional"]').val(data.jabfung.id);
      });
    });
  });
...
var updateJabFung = /*#__PURE__*/function () {
  ...
  return function updateJabFung(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

var deleteJabFung = function deleteJabFung(data) {
...
$(document).ready(function () {
  ...
  selectOptionIntansiPembina(); // show option rumpun jabatan
  ...
  selectOptionKategori(); // store data

  $("#btnAddJabFung").click(function () {
    $(".check-kategori:checkbox:checked").each(function (index, element) {
      var kategoriValue = $(element).val();
      $(".check-lingkup:checkbox:checked").each(function (idx, el) {
        var linkupValue = $(el).val();
        var data = {
          ...
          lingkup: linkupValue,
          message: "".concat($('select[name="jabatan-fungsional"] option:selected').html(), " - ").concat($(element).next().text(), " - ").concat($(el).next().text(), " ")
        };
        checkDetailJabfung(data); // insertDetailJabFung(data);
      });
    }); // insertJabFung(data);
...
/***/ 9:
/*!**************************************************************!*\
  !*** multi ./resources/js/demo/datatables-detail-jabfung.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\Projects\Git\sibafung-new\resources\js\demo\datatables-detail-jabfung.js */"./resources/js/demo/datatables-detail-jabfung.js");
